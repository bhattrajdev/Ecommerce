        ...
        <table>
            ...
            WHERE orderproducts.product_id = " . $item['product_id']);
                    ...
                    <tr>
                        ...
                        <td>RS <?= $item['price'] ?></td>
                        <td>
                            <a href="usersalesDetail?id=<?= $item['product_id'] ?>"><button class="btn btn-success"> <i class="fa-solid fa-eye"></i> View</button></a>

                        </td>
                        <td>
                            <?php if (!empty($data2)) { ?>
                                <a href="usersalesRequests.php?id=<?= $item['product_id'] ?>">
